              ...
              <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
                ...
                <div className="pt-8 grid grid-cols-3 gap-4 border-t border-neutral-150/70 text-center lg:text-left max-w-lg mx-auto lg:mx-0">
                  <div className="space-y-0.5">
                    <span className="block text-2xl md:text-3xl font-bold font-mono text-brand-emerald">20+</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                <div className="relative">
                  ...
                  <div className="relative bg-white p-3 rounded-2xl shadow-xl overflow-hidden max-w-sm group">
                    ...
                    <div className="p-4 text-center">
                      ...
                      <p className="text-xs text-neutral-500 font-semibold mt-0.5">Бухгалтер-експерт</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="lg:col-span-7 space-y-6">
                ...
                <div className="text-neutral-600 space-y-4 text-sm md:text-base leading-relaxed">
                  <p>
                    Вітаю! Я — <strong>Оксана Фальонок</strong>, сертифікований практикуючий бухгалтер. Мій шлях у сфері фінансів та обліку почався понад 20 років тому. За цей час я допомогла десяткам підприємців налагодити фінансовий облік, успішно пройти перевірки та уникнути штрафів ДПС.
                  </p>
                  <p>
